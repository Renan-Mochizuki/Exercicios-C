...
// a) Crie 2 vetores de inteiros positivos (maiores ou iguais a 0) distintos que tenham tamanho máximo 
//    de 20 elementos cada. E insira elementos para cada um dos vetores, onde o critério de parada para inserção 
//    dos elementos em um vetor é a inserção do 20º elemento ou que seja inserido um valor negativo.
// b) Ordene, de forma crescente, cada um desses vetores.
// c) Crie 2 novos vetores de inteiros (de tamanho máximo 40) para que:
// 1. O terceiro vetor seja um merge * dos outros dois iniciais e esses devem ser passados como parâmetro para  
//    uma rotina específica. Este terceiro vetor não terá valores repetidos.
// 2. O quarto vetor contenha os elementos que indicaram alguma repetição de valores que estejam nos dois vetores iniciais.
// Obs: Cuidado!!! Pois podem haver repetições de valores nos vetores iniciais e lembrem que o vetor do “merge” 
