...
// 3. Apresente um programa na linguagem C que crie e insira os elementos em dois vetores distintos 
// de inteiros de tamanho máximo 20 elementos. Este programa deve indicar quais elementos que estão no 
// vetor 1 são repetidos no vetor 2. Para esse exercício assuma que não há repetições de elementos no vetor 1.
